...
starii=[];
Threshold1=-inf;
overlapped=[4 5 6 7 11 14 16 17 19 20 28 29 32 33];
nonoverlapped =[2 7 9 14 15 18 21 22 23 24 27 26 30 31];
load('D:\LEVIS\video_clips_pca\label_SAVIOT_330.mat')
label=label_SAVIOT_330(:,nonoverlapped);
load('D:\LEVIS\video_clips_pca\FK_projected_ubm_SAVIOT.mat')
final_niter = 10;
nmix=2;Thresholdtemp=0.01;
ds_factor = 2;
UBM=FK_projected_ubm_SAVIOT(:,1:200);
FK_UBMBackground_projected={UBM'};
ubm = gmm_em(FK_UBMBackground_projected,nmix, final_niter, ds_factor,12);
clear FK_UBMBackground_projected;clear final_niter;clear ds_factor;clear UBM;clear FK_projected_ubm_SAVIOT
save ubm_saviot ubm
load('D:\LEVIS\video_clips_pca\FK_Data_SAVIOT_330.mat')
Data=FK_Data_SAVIOT_330(:,nonoverlapped);
for  Threshold2=1200:400:2000%1200:300:2000
    num=1;
    %-------------528
    for LIMITmax=-5:8:45%0:0.4:1.5%
        update_number=0;
        discard_number=0;
        flag=0;
        novelty=0;
